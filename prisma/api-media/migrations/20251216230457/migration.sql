...
-- CreateEnum
CREATE TYPE "Platform" AS ENUM ('arclight', 'watch', 'journeys');
...
-- CreateEnum
CREATE TYPE "VideoVariantDownloadQuality" AS ENUM ('low', 'high', 'sd', 'highest', 'distroLow', 'distroSd', 'distroHigh', 'fhd', 'qhd', 'uhd');
...
CREATE TABLE "CloudflareImage" (
    ...
    "videoId" TEXT,
    "blurhash" TEXT,
    "blurhashAttemptedAt" TIMESTAMP(3),
...
CREATE TABLE "Video" (
    ...
    "originId" TEXT,
    "restrictDownloadPlatforms" "Platform"[] DEFAULT ARRAY[]::"Platform"[],
    "restrictViewPlatforms" "Platform"[] DEFAULT ARRAY[]::"Platform"[],
